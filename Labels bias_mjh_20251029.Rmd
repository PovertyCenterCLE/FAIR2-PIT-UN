...
ggsave(here::here("output", "health_histogram.png"), dpi = 200, width = 5, height = 3)
```
...
ggsave(here::here("output", "health_by_homeless_histogram.png"), dpi = 200, width = 5, height = 3)
...
ggsave("pred_prob_fig.png", dpi = 200, width = 7, height = 5)
